  ...
  const Trajectory<TrajectoryPointType> & trajectory, const geometry_msgs::msg::Point & point)
{
  ...
  return find_precise_index(trajectory, point, min_idx);
}
  ...
  const double yaw_threshold = std::numeric_limits<double>::max())
{
  ...
  if (base_nearest_index.has_value()) {
    return find_precise_index(trajectory, pose, *base_nearest_index, dist_threshold, yaw_threshold);
  } else {
    return std::nullopt;
  }
}
...
extern template std::optional<double> find_nearest_index<autoware_planning_msgs::msg::PathPoint>(
...
// extern template std::optional<double> find_nearest_index<geometry_msgs::msg::Point>(
//   const Trajectory<geometry_msgs::msg::Point> & trajectory,
//   const geometry_msgs::msg::Point & point);

extern template std::optional<double> find_nearest_index<geometry_msgs::msg::Pose>(
  const Trajectory<geometry_msgs::msg::Pose> & trajectory, const geometry_msgs::msg::Point & point);

extern template std::optional<double>
find_nearest_index<autoware_planning_msgs::msg::TrajectoryPoint>(
